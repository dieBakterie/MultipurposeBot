...
-- ====================================
DROP TABLE IF EXISTS channel_name_changes;
...
-- Indexes for twitch_streamers
CREATE INDEX idx_twitch_streamer_name ON twitch_streamers (user_name);
CREATE INDEX idx_twitch_streamers_streamer_name_channel_id ON twitch_streamers (user_name, discord_channel_id, discord_channel_name);
CREATE INDEX idx_twitch_streamers_updated_at ON twitch_streamers (updated_at);

-- Trigger for twitch_streamers.updated_at
